/*
    ...
    Date:   April 21th, 2021  12:44pm updated May 1st and May 2nd
    Purpose:Creating winners and able to loop the game until player is done
 * adding a menu
 * setting up the file  i/o (tracking wins/losses/draws) without fstream yet.
 */
...
int main(int argc, char** argv) {
  ...
  //------------------------------------------------------------------------------
    ...
    cout << "Your wins for this session are :" << wins << '\n';
    cout << "Your losses for this session are: " << losses << '\n';
    cout << "Your draws/push for this session are: " << draws << '\n';
    //Exit stage right
    return 0;
}
